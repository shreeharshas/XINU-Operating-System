 ...
 *------------------------------------------------------------------------
 */
shellcmd xsh_clntprg(int nargs, char *args[])
{
	int	i;			/* index into buffer		*/
	int	retval;			/* return value			*/
	char	msg[] = "Testing udp client packet"; /* message to send	*/
...
//kprintf("\ninbuf: %s\n",(char *)inbuf);
/*debug purpose*/
//kprintf("\nFile xsh_clntprg.c; Function xsh_clntprg; retval after udp_recv: %d\n", retval);
		if (retval == TIMEOUT) {
